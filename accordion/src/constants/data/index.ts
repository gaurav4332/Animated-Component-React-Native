export const faqs = [
    ...
    },
    {
      ...
      description:
        "Yes, we have a loyalty program that rewards you with points for every purchase. You can redeem these points for discounts on future purchases. Sign up on our website to join our loyalty program and start earning points today.",
    },
    {
      id: "12",
      title: "How do I reset my password?",
      description:
        "To reset your password, go to the login page and click on 'Forgot Password'. Enter your email address, and we will send you a link to reset your password. Follow the instructions in the email to create a new password.",
    },
    {
      id: "13",
      title: "Can I change my shipping address after placing an order?",
      description:
        "If your order has not yet been processed, you can change your shipping address by contacting our customer service team. Once the order has been processed, we are unable to change the shipping address.",
    },
    {
      id: "14",
      title: "Do you offer price matching?",
      description:
        "Yes, we offer price matching on identical items found at a lower price from a competitor. Please contact our customer service team with proof of the lower price, and we will match it.",
    },
    {
      id: "15",
      title: "How do I subscribe to your newsletter?",
      description:
        "You can subscribe to our newsletter by entering your email address in the subscription box at the bottom of our website. You will receive updates on new products, promotions, and exclusive offers.",
    },
    {
      id: "16",
      title: "Can I place an order over the phone?",
      description:
        "Yes, you can place an order over the phone by contacting our customer service team. They will assist you in placing your order and answering any questions you may have.",
    },
    {
      id: "17",
      title: "Do you offer financing options?",
      description:
        "Yes, we offer financing options through our partner Klarna. You can choose to pay in installments at checkout. For more information, please visit our financing page.",
    },
    {
      id: "18",
      title: "How do I leave a review?",
      description:
        "You can leave a review on the product page of the item you purchased. Scroll down to the reviews section and click on 'Write a Review'. Your feedback is important to us and helps other customers make informed decisions.",
    },
    {
      id: "19",
      title: "What should I do if I receive a damaged item?",
      description:
        "If you receive a damaged item, please contact our customer service team immediately. Provide them with your order number and a photo of the damaged item. We will arrange for a replacement or refund as soon as possible.",
    },
    {
      id: "20",
      title: "Do you offer student discounts?",
      description:
        "Yes, we offer a 10% discount for students. To avail of this discount, please verify your student status through our partner Student Beans. Once verified, you will receive a discount code that can be applied at checkout.",
    },
  ];
